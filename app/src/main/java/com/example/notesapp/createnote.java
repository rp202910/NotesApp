...
public class createnote extends AppCompatActivity {
    ...
    EditText mcreatetile,mcreatecontent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcreatecontent=findViewById(R.id.tool);
        mcreatetile=findViewById(R.id.createtitle);
        ...
        mcreatenote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String title=mcreatetile.getText().toString();
